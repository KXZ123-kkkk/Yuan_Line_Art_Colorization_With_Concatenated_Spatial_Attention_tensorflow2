...
if __name__ == '__main__':
    ls = tf.io.read_file(r"C:\Users\ASUS\Desktop\2.jpg")
    zz = tf.image.decode_jpeg(ls).numpy()
    lz = tps_transform(zz)
    ls = np.asarray(lz, dtype=np.uint8)
    Image.fromarray(ls).save(r"C:\Users\ASUS\Desktop\2.png")